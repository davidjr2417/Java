 ...
 * 
 * HINT: Use Array for Community Norms
 */
package myPrograms;
import java.util.Scanner;

public class GeniusVariablesAndObjects {
	...
	public static void gotHistory(String [] geniusInfo) {
		/* Create Scanner*/
		Scanner scanInput = new Scanner(System.in);
		
		System.out.println("What Is Your Age?");  //Print Genius Name
		String name = scanInput.nextLine();
		
		//Create A String With The Literal Value ... And Store In Variable ... Maybe Include 1 new String("a"); Literal or prompt
		
		
		
		System.out.println("How Many Siblings Do You Have?");  //Print Genius Name
		String name = scanInput.nextLine();
		
		System.out.println("What School Do You Go To?");  //Print Genius Name
		String name = scanInput.nextLine();
		
		System.out.println("How Many Close Friends Do You Have?");  //Print Genius Name
		String name = scanInput.nextLine();
		
		System.out.println("What Do You Like To Do With Your Friends?");  //Print Genius Name
		String name = scanInput.nextLine();
		
		
//		Create A Bio With Literals and variables
	}
